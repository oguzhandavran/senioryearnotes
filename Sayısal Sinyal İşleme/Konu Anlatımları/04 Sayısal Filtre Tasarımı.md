...
```mermaid
flowchart LR
    A["Sayısal<br/>Specs"] --> B["Frekans önceden<br/>düzeltme<br/><i>(prewarping)</i>"]
    B --> C["Analog Prototip<br/>H_a(s)<br/><i>Butterworth / Cheby.</i>"]
    C --> D["<b>Bilineer Dön.</b><br/><i>s → z</i><br/><b>H(z) ✓</b>"]
    style A fill:#eef2f7,stroke:#1a1a2e
    style B fill:#eef2f7,stroke:#1a1a2e
