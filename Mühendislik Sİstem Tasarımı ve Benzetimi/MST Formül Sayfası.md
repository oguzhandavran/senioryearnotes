...
> [!tip] T — Kinetik Enerji
> $$T = \frac{1}{2}m\dot{q}^2 \quad \text{veya} \quad T = \frac{1}{2}I\dot{\theta}^2$$

> [!example] V — Potansiyel Enerji
> $$V = \frac{1}{2}kq^2$$

> [!warning] D — Rayleigh Dissipation (Sönüm)
> $$D = \frac{1}{2}b\dot{q}^2$$

> [!info] Koordinatlar ve Kuvvetler
> - **$q_i$**: Genelleştirilmiş koordinat (konum)
> - **$Q_i$**: Genelleştirilmiş dış kuvvet (uygulanmış)
