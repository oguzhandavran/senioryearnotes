...
```mermaid
flowchart LR
    UZEM["<b>MSÜ UZEM</b><br/>(giriş gerekli)"]
    JAST["<b>JAST Dergi</b><br/>(açık erişim)"]
    KAR["<b>Dr. Karakuş (SS PDF)</b>"]
    SON["<b>Sonugür (OK Notu)</b>"]
    EMD["EMD Ana Sayfa"]
    OK["OK Ana Sayfa"]
    MST["MST Ana Sayfa"]
    SSI["SSI Ana Sayfa"]
    ...
    KAR --> SS
    SON --> OK
    style UZEM fill:#ff6b6b,color:#ffffff,stroke:#1a1a2e
    style JAST fill:#4ecdc4,stroke:#1a1a2e
    style KAR fill:#45b7d1,color:#ffffff,stroke:#1a1a2e
    style SON fill:#96ceb4,stroke:#1a1a2e
    style EMD fill:#DC503C,color:#ffffff,stroke:#1a1a2e
    style OK fill:#FFA500,stroke:#1a1a2e
